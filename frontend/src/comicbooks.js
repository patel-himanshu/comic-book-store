const comicbooks = [
  ...
  },
  {
    ...
    creators:
      "Chris Claremont, Jim Lee, Whilce Portacio, Louise Simonson, Peter Dav'id', John Bryne",
    publisher: "Marvel",
    printLength: "832",
    price: "₹ 8,559.98",
    stock: "10",
  ...
  {
    id: "7",
    name: "Sp'id'er-Man: The Complete Collection",
    image: "../assets/sp'id'er-man.jpg",
    description:
      "Todd McFarlane became a superstar illust'rating' 'AMAZING SP''ID'ER-MAN, but he changed the industry forever with his next project: the 'adjectiveless' SP'ID'ER-MAN! Taking on both writing and art duties, McFarlane ushered Peter Parker into a gritty new era - and it began with 'Torment'! When the Big Apple's streets run red with blood, the web-slinger heads into the sewers to stop the Lizard's homic'id'al rampage. But what is driving his old friend and foe? Plus: Ghost R'id'er lends a bony hand when the deranged Hobgoblin returns, the wall-crawler finds himself at the center of a clash of claws between Wolverine and Wendigo, and Pete goes back in black to face Morbius the Living Vampire! And in the ultimate nineties team-up, Sp'id'ey joins X-Force to battle the unstoppable Juggernaut!",
  ...
  },
  {
    ...
    description:
      "Deadpool Kills the Marvel Universe: What if everthing you thought was funny about Deadpool...was actually just disturbing? What if he dec'id'ed to kill everyone and everything that makes up the Marvel Universe? What if he actually pulled it off? Would that be FUN for you? The Merc with a Mouth takes a turn for the twisted in a weekly horror comic like no other...",
  ...
  },
  {
    ...
    description:
      "Revamped, redesigned, and fully updated to include the New 52 and Rebirth storylines, this is the definitive and indispensable gu'id'e to the characters and worlds of the DC Comics Universe. Created in full collaboration with DC Comics, this comprehensive reference book has The Washington Post saying, 'The DC Comics Encyclopedia is a must.' Formatted in an easy-to use A-to-Z layout, this gu'id'e is packed with information and thrilling comic book art and features more than 1,100 characters including Batman, Superman, Wonder Woman, The Joker, and much more. The DC Comics Encyclopedia All-New Edition brings everything up to date, prov'id'ing an accessible, compelling, and lavishly illustrated gu'id'e to the dynamics of the DC Comics Universe.",
  ...
  },
  {
    ...
    description:
      "Not a dream, not an imaginary story, not an elseworld. This is Flash Fact: When Barry Allen wakes at his desk, he discovers the world has changed. Family is alive, loved ones are strangers, and close friends are different, gone or worse. It's a world on the brink of a cataclysmic war—but where are Earth's Greatest Heroes to stop it? It's a place where America's last hope is Cyborg, who hopes to gather the forces of The Outs'id'er, The Secret 7, Shazam!, Citizen Cold and other new and familiar-yetaltered faces! It's a world that could be running out of time, if The Flash can't find the villain who altered the time line!",
  ...
  },
  {
    ...
    description:
      "The original series faithfully reproduced after 25 years! After saving their own world from a celestial catastrophe, the Autobots and Decepticons have crashed landed on Earth! Each s'id'e sets out to explore their new surroundings, seeking resources and possibly allies. One such ally may be a bookworm 'name'd Buster Witwicky, and his mechanic father, Sparkplug.",
    creators: "Bill Mantlo, Ralph Macchio, Jim Salicrup, Bob Budiansky",
    publisher: "'ID'W Publishing",
    printLength: "318",
    price: "₹ 912.30",
    stock: "9",
    rating: "4.7",
